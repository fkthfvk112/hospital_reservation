...
values("김사랑 치과","건강한 치아 관리","치과","20","30","3~6","바나나",null);

insert into hospital(title,description,sort,location_latitude,location_longitude,opertime,staff_id,del_date)
values("코끼리 이비인후과","아동 이비인후과","이비인후과","20","30","3~6","banana",null);

insert into hospital(title,description,sort,location_latitude,location_longitude,opertime,staff_id,del_date)
values("강철본드 정형외과","한번 붙은 뼈는 다시 안 부러지도록","정형외과","20","30","3~6","banana",null);